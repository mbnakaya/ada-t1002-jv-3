...
//
//        System.out.println("allMatch() em Stream infinita: " + list.stream().allMatch(predicate1));
//        System.out.println("anyMatch() em Stream infinita: " + list.stream().anyMatch(predicate1));
//        System.out.println("noneMatch() em Stream infinita: " + list.stream().noneMatch(predicate1));
//        System.out.println();
